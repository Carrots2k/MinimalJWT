...
GO
PRINT N'Altering Procedure [dbo].[spMovie_Get]...';


GO
ALTER PROCEDURE [dbo].[spMovie_Get]
	@Id int
AS
begin
...
GO
PRINT N'Altering Procedure [dbo].[spMovie_GetAll]...';


GO
ALTER PROCEDURE [dbo].[spMovie_GetAll]
AS
begin
	select id, title, description, rating
	from dbo.[Movies];
